        ...
        >
          ...
          <div className="flex-1 flex flex-col justify-center text-center md:text-left">
            ...
            <p className="mt-4 text-gray-300 leading-relaxed text-base sm:text-lg max-w-2xl md:max-w-3xl">
              I build scalable,Decentralized applications with a strong focus on Blockchain Technology, delightful Smart Contract,Ethereum, and performance. My toolkit spans Java, React, TypeScript, Tailwind CSS, and FastAPI—bringing ideas to life from concept to production with robust APIs and smooth interfaces.
            </p>
            ...
            <div className="mt-6 grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4 max-w-xl">
              {[
                ...
                { label: "Specialty", value: "Blockchain-Etherum" },
                { label: "Focus", value: "Smart Contract" },
              ].map((item, i) => (
                <motion.div
                  key={i}
