...
const socials = [
  ...
  { Icon: FaLinkedinIn, label: "LinkedIn", href: "https://www.linkedin.com/in/rohit-kumar-5309b022a/" },
  { Icon: FaInstagram, label: "Instagram", href: "https://www.instagram.com/Rohit12ka/" },
...
const Home = React.forwardRef((props, ref) => {
  const roles = useMemo(
    () => ["Blockchain Developer", "Web3 Developer", "Contract Creator"],
    []
  );
